...
function Cart() {
  ...
  const onRemoveCartItem = (id) => {
    if (window.confirm('Видалити піццу з кошика?')) {
          ...
          {totalPrice ? (
            <>
              <div className="cart__header">
                ...
                <button className="cart__clear" type="button" onClick={onClearCart}>
              ...
              <div className="cart__footer">
                ...
                <button className="cart__pay" type="button" onClick={onClickOrder}>
                  Сплатити зараз
                </button>
              </div>
            </>
