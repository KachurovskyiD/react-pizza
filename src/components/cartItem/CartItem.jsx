...
function CartItem({ id, imageUrl, name, type, size, totalPrice, totalCount, onRemoveItem, onPlus, onMinus }) {

  const handlerOnPlusItem = () => {
    onPlus(id);
  }

  const handlerOnMinusItem = () => {
    onMinus(id);
  }
    ...
    <div className="cart-item">
      <div className="cart-item__left-block">
        ...
        <div className="cart-item__description">
          ...
          <span className="cart-item__options">{type} тісто, {size} см.</span>
        </div>
      </div>
      <div className="cart-item__right-block">
        <div className="cart-item__count">
          <button className="cart-item__count-btn cart-item__count-minus" onClick={handlerOnMinusItem}>
          ...
          <div className="cart-item__counter">{totalCount}</div>
          <button className="cart-item__count-btn cart-item__count-plus" onClick={handlerOnPlusItem}>
        ...
        <button className="cart-item__remove" type="button" onClick={() => onRemoveItem(id)}>
